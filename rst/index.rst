...
La differenza tra la versione 1.0 e la 2.0 consiste nel fatto che nella versione 2.0 è stato contemplato l’uso della modalità ```richiesta avanzata``` (nell’applicativo informatico “MAIA”) che consente all’operatore di prescindere da un’attività di pre-protocollazione (prevista invece nella versione 1.0).
Vai alla `versione 2.0 <https://manuale-libro-firma-2-0.readthedocs.io>`_.
