...
Per l'integrazione dei commenti tramite Diquis ho riusato il progetto del [comune di Gioia del Colle][qui](http://foia.readthedocs.io/en/latest/) che si trova [qui](https://github.com/gioialab/foia/tree/master/source/_themes/sphinx_italia_theme)
